  ...
  <div class="content">
    <div class="header">
      ...
      <div class="user-box">
        ...
        <a href="javascript:;" @click="logout" class="out">注销</a>
      </div>
      <ul class="clear">
        <li>
...
<style scoped>
  ...
  .content .header{width:6.4rem;height:3rem; background:#9e9a95; padding-top:0.4rem;}
  .header h2{width:1.02rem;height:1.02rem; border-radius:50%; margin:0 auto;}
  .header h2 img{width:100%; }
  .header .user-box{width:2rem; text-align: center;font-size:0.25rem; color:#fff; margin:0 auto; margin-top:0.2rem;}
  .user-box a{color:#fff;}
  .user-box .out{color:red;}
  ...
  .content .docList{width:6.4rem; margin:0 auto; }
